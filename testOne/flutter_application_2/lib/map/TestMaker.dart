...
List<dynamic> listMoto = [[16.472119, 102.825444, "EN04"],
[16.472361, 102.824580, "PHO"], [16.474032, 102.823235, "N50"]];

List<dynamic> listCar = [[16.471208, 102.824758, "Car zone A"],
[16.471218, 102.824117, "Car zone C"], [16.471457, 102.822973, "Car zone E"]];
  ...
  for (var i = 0; i < listSize; i++) {
    setIn.add(Marker(
      ...
      infoWindow: InfoWindow(
        ...
        snippet: "This marker park of ${listMoto[i][2]}", //snippet message on mark @ChangNoi
      ),
  ...
  for (var i = 0; i < listSize; i++) {
    setIn.add(Marker(
      ...
      infoWindow: InfoWindow(
        ...
        snippet: "This marker park of ${listCar[i][2]}", //snippet message on mark @ChangNoi
      ),
